                ...
                <div>
                  ...
                  <table class="w-full text-xs">
                    <tbody class="text-muted-foreground">
                      ...
                      <tr><td class="py-0.5 pr-3 font-mono text-foreground">Threshold</td><td>Bandwidth allocation for this tin. This is not a hard cap — when other tins are idle, any tin can burst up to the full link speed. Higher-priority tins (Voice, Video) have lower thresholds because they need low latency, not high bandwidth. Best Effort gets the largest share since it carries bulk web traffic. Priority determines scheduling order (who gets sent first), while threshold limits how much bandwidth each tier can sustain.</td></tr>
